TEXTS = {
    "ru": {
        ...
        "welcome": (
            "👋 Добро пожаловать в <b>GGshop XENO</b>!\n\n"
            "🎮 Продажа читов для <b>Roblox</b>\n"
            "⚡ Быстрая выдача ключей после оплаты\n\n"
        ...
        "payment_success": (
            ...
            "🔑 Твой ключ (Roblox username): <code>{username}</code>\n\n"
            "📦 Тариф: <b>{plan}</b>\n"
            "⏳ Период: <b>{period}</b>\n\n"
    ...
    "en": {
        ...
        "welcome": (
            "👋 Welcome to <b>GGshop XENO</b>!\n\n"
            "🎮 Roblox cheats for sale\n"
        ...
        "payment_success": (
            ...
            "🔑 Your key (Roblox username): <code>{username}</code>\n\n"
            "📦 Plan: <b>{plan}</b>\n"
            "⏳ Period: <b>{period}</b>\n\n"
